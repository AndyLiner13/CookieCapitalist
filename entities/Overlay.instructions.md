...
**Hierarchy**: `root` / [`Noesis Gizmos`](Noesis Gizmos.instructions.md) / [`Overlay`](Overlay.instructions.md)
...
| **leaderboardGizmo** | `Object` |
| **milkBackgroundGizmo** | `Milk Background` |
| **milkForegroundGizmo** | `Milk Foreground` |

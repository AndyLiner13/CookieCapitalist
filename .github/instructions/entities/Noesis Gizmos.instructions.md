...
| **playerController** | [`Player Controller`](Player%20Controller.instructions.md) |
| **sfxManager** | [`SFX Manager`](SFX%20Manager.instructions.md) |
| **mobileOnlyGizmo** | [`MobileOnly Modal`](MobileOnly%20Modal.instructions.md) |
| **resetStats** | `false` |
| **mobileOnly** | `true` |
